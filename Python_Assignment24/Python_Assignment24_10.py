...
df.to_csv('final_student_results.csv', index=False)

print("Final DataFrame exported to 'final_student_results.csv'")
...
plt.hist(df['Mathematics'], bins=5, color='skyblue', edgecolor='black')
plt.title('Distribution of Mathematics Marks')
...
sns.boxplot(y=df['English'], color='lightblue')
